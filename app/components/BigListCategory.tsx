        ...
        for (let i = 0; i < 151; i++) {
            skeletons.push(
                <View key={i} style={styles.horizontalScrollCards}>
                    <Skeleton colorMode="light" height={205} width={142} radius="square" />
                </View>
            );
        }
        return skeletons;
                        ...
                        <View key={cat.id} style={styles.horizontalScrollCards}>
                            {cat.imageError ? (
                                ...
                                <Image
                                    ...
                                    style={{ width: 142, height: 205, zIndex: 0, borderRadius: 10 }}
